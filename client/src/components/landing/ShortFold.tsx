    ...
    <section className="py-20 lg:py-28 bg-surface/30 border-y border-stroke/30">
      <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
        <p className="text-2xl lg:text-3xl font-display font-semibold text-text leading-relaxed mb-6">
          Projetos não reprovam por tecnologia.<br /> Perdem por proposta{" "}
        ...
        <p className="text-lg text-text-muted">
          Uma proposta reprovada custa meses de projeto, às vezes a janela de mercado inteira. <br />O Fomento para Deeptechs existe para você não passar por isso de novo.
        </p>
      </div>
    </section>
  );
